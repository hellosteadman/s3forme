...
#  modified 2013 by marksteadman@me.com

import base64, hmac, httplib, hashlib, tempfile, time, urllib, urlparse, xml.sax
from cStringIO import StringIO

DEFAULT_HOST = 'rest.s3for.me'
...
class S3fmAuthConnection(object):
...
class QueryStringAuthGenerator(object):
	...
	def generate_url(self, method, bucket='', key='', query_args=None,
		...
		query_args['S3fmAccessKeyId'] = self.aws_access_key_id
